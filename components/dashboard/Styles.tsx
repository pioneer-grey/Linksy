...
const Styles = () => {
  const{setDesktopBackgroundColor,setPrimaryBackground,
    ...
    setProfilePictureShadow}=useStyles()
    ...
    <div className='bg-card max-h-screen overflow-auto'>
        <div className='border-b mb-2'>
          ...
          <div className='flex items-center justify-between border-2 p-2 m-2 rounded-2xl '>
            ...
            <Input className='w-15' type='color' onChange={(e)=>{setPrimaryTextColor(e.target.value)}}></Input>
          </div>
          <div className='flex items-center justify-between border-2 p-2 m-2 rounded-2xl'>
            <p className='text-sm font-light'>Primary Background</p>
            <Input className='w-15' type='color' onChange={(e)=>{setPrimaryBackground(e.target.value)}}></Input>
          </div>
            <div className='flex items-center justify-between border-2 p-2 m-2 rounded-2xl'>
            <p className='text-sm font-light'>Desktop Background Color</p>
            <Input className='w-15' type='color' onChange={(e)=>{setDesktopBackgroundColor(e.target.value)}}></Input>
          </div>
        </div>
